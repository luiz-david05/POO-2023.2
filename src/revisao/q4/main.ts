...
function inicializar(capacidadeElevador: number, totalAndares: number) {    
    try {
        let novoElevador: Elevador = elevador.inicializar(capacidadeElevador, totalAndares)
    }
    catch {
...
function main() {
    const opcoes: Array<Function> = new Array(
        inicializar,
        entrar,
        sair,
        subir,
